...
<script type="text/javascript">
	...
	function showPromoDetails(idx)
	{
		$('#promo-details').modal('show');

		$('#promo-details img').attr('src',mainData[idx].image);
		$('#promo-details .card-title').html(mainData[idx].promo_name);
		$('#promo-details .card-text').html(mainData[idx].detail);
	}
		...
		<div id="template" class="col-12 col-md-6 col-lg-4 pb-3" style="display:block">
			...
			<div class="card text-center promo-card" style="width:100%">
				...
				<div class="card-body">
					...
					<a href="javascript:showPromoDetails(0)" class="btn btn-apply">MORE DETAILS</a>
				</div>
			</div>
